    ...
    <div class="article-body grid grid-cols-12 gap-3 mt-5 items-start">
        ...
        <div class="col-span-8">
            <div class="article-meta flex py-1 text-sm items-center">
               ...
               <img class="w-7 h-7 rounded-full mr-3" src="{{ $post->author->profile_photo_url ?? 'https://ui-avatars.com/api/?name='.urlencode($post->author->name).'&color=7F9CF5&background=EBF4FF' }}">
